...
export const LEAF_COMMONS = {
  ...
  monitorResponseAvg: () => numCommon(tName("monitorResponseAvg"), "ms", "value", tDesc("descMonitorResponseHour")),
  monitorResponseMin: () => numCommon(tName("monitorResponseMin"), "ms", "value", tDesc("descMonitorResponseHour")),
  monitorResponseMax: () => numCommon(tName("monitorResponseMax"), "ms", "value", tDesc("descMonitorResponseHour")),
