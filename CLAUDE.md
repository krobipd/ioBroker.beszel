...
## Tests (288 unit + 57 package + 1 integration = 346)
...
| 0.5.2 | **Hotfix #2 Migration-Loop.** js-controller-7-encrypt-Format nicht erkannt. |
| 0.5.1 | **Hotfix.** `encryptedNative` Manifest-Fix auf `["username", "password"]`. |
